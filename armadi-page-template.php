		...
		$prodotti = array(
			...
			if ( $serie->have_posts() ) :?>
				...
				<li class="<?php if ($post_id === translated_id( get_the_ID())){echo 'active';} ?>">
                    ...
                    <?php if ($atos_versione['slug'] == 'automatica') { ?><span class="label label-warning"> A</span> <?php } ?>
            ...
            <div id="dati-prodotto">
                ...
                <div id="desc-prodotto">
                    ...
                    <?php if ($atos_versione['slug'] == 'automatica') { ?><span class="label label-warning"> Automatica</span> <?php } ?>
                </div>
                ...
                <div id="misure-small">
					...
					?>
                	<h5><?php echo __('Specifications', 'at-os'); ?></h5>
