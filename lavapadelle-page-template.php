...
?>
    ...
    <div id="scheda-dettagli" class="clearfix">
		...
		$prodotti = array(
			...
			if ( $serie->have_posts() ) :?>
				...
				<li class="<?php if ($post_id === translated_id( get_the_ID())){echo 'active';} ?> ">
                	<a class="product" data-container="body" rel="tooltip" data-toggle="tooltip" title="<?php echo get_the_title(); ?>" data-postid="<?php echo get_the_ID() ?>"  href="<?php echo  get_permalink(get_the_ID()); ?>">
                    
				<?php if(function_exists('immagine_carosello')) echo immagine_carosello(get_the_ID(), 'thumb-carosello' );?>
                	</a>
                </li>
            ...
            <div id="dati-prodotto">
                ...
                <div id="desc-prodotto">
                	<h5><?php /* Descrizione */ echo __('Description', 'at-os'); ?></h5>
                	<p><?php the_content(); ?></p>
                    
                    <?php if ($atos_versione['id'] == translated_id (40 , 'versione')) { ?><span class="label label-warning"> <?php echo __('Automatic', 'at-os'); ?></span> <?php } ?>
                </div>
                ...
                <div id="misure-small">
					...
					?>
                	<h5><?php echo __('Features', 'at-os'); ?></h5>
					...
					$axl_at_os_brochure_args = array(
													...
													'tax_query' => array(
														array(
															'taxonomy' => 'linea',
															'field' => 'id',
															'terms' => translated_id ( $atos_linea['id'] , 'linea'),
														)
													)
        ...
        <ul id="nav-prodotto" class="clearfix">
            ...
            <li><a rel="popup" href="<?php $image =  wp_get_attachment_image_src( get_post_thumbnail_id($post_id), 'full');  echo $image[0]?>" ><i class="fa fa-arrows-alt"></i> <?php echo __('Full screen view', 'at-os'); ?></a></li>
